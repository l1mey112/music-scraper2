...
// 'cover_art_large' size >= 512x512
export type MediaKind = 'cover_art_small' | 'cover_art_large' | /* 'audio_q2' | */ 'audio0'

// following streamrip quality standards
...
// youtube provides around 131 kbps, so quality 0 (audio0)
